...
stateVariableDeclaration
  : typeName
    (StaticKeyword | PublicKeyword | InternalKeyword | PrivateKeyword | ConstantKeyword | ImmutableKeyword | NostorageKeyword | overrideSpecifier )*
...
identifier
  : ( 'msgValue' | 'from' | 'calldata' | 'receive' | 'callback' | 'revert' | 'error' | ConstructorKeyword | PayableKeyword | LeaveKeyword | GlobalKeyword | Identifier) ;
